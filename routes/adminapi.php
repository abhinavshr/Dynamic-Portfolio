...
Route::prefix('admin')->middleware('auth:admin')->group(function () {
    ...
    Route::get('/total-projects', [ProjectController::class, 'totalProjects'])->name('admin.totalprojects');
    Route::get('recent-projects', [ProjectController::class, 'recentProjects'])->name('admin.recentprojects');
    ...
    Route::get('/project-images/{id}', [ProjectImageController::class, 'showProjectImage'])->name('admin.viewprojectimagebyid');
    ...
    Route::get('/total-contacts', [ContactController::class, 'totalContacts'])->name('admin.totalcontacts');
    Route::get('recent-contacts', [ContactController::class, 'recentContacts'])->name('admin.recentcontacts');
